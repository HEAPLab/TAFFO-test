; ModuleID = './function-return-ptr.out.2.taffotmp.ll'
...
entry:
  ret float* @glob, !taffo.initweight !7, !taffo.info !8
}

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !taffo.initweight !5 !taffo.funinfo !5 !taffo.start !9 {
entry:
  %t = alloca float, align 4, !taffo.initweight !0, !taffo.info !10
  %call = call float* @fun.1(), !taffo.initweight !0, !taffo.info !1, !taffo.originalCall !11, !taffo.constinfo !12
  %t2 = bitcast float* %t to i8*, !taffo.initweight !7, !taffo.info !10
  %call3 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), float* %t), !taffo.initweight !7, !taffo.info !10, !taffo.constinfo !13
  %0 = load float, float* %t, align 4, !taffo.initweight !7, !taffo.info !10
  store float %0, float* %call, align 4, !taffo.initweight !14, !taffo.info !8, !taffo.target !15
  %1 = load float, float* %call, align 4, !taffo.initweight !14, !taffo.info !1, !taffo.target !15
  %conv = fpext float %1 to double, !taffo.initweight !16, !taffo.info !1, !taffo.target !15
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), double %conv), !taffo.initweight !17, !taffo.info !8, !taffo.target !15, !taffo.constinfo !13
  ret i32 0
}
...
declare !taffo.initweight !20 !taffo.funinfo !21 dso_local i32 @__isoc99_scanf(i8*, ...) #2

declare !taffo.initweight !20 !taffo.funinfo !21 dso_local i32 @printf(i8*, ...) #2

; Function Attrs: noinline nounwind uwtable
define internal float* @fun.1() #0 !taffo.initweight !5 !taffo.funinfo !5 !taffo.sourceFunction !11 {
entry:
  ret float* @glob, !taffo.initweight !7, !taffo.info !8
}
