; ModuleID = './test8.out.3.taffotmp.ll'
...
entry:
  ...
  %sub4 = fsub float %2, %3, !taffo.initweight !6, !taffo.info !11
  %4 = load float, float* %hp, align 4, !taffo.initweight !6, !taffo.info !14
  %sub5 = fsub float %4, %sub4, !taffo.initweight !4, !taffo.info !15
  store float %sub5, float* %hp, align 4, !taffo.initweight !6, !taffo.info !17
  %5 = load float, float* %hp, align 4, !taffo.initweight !6, !taffo.info !18
  ret float %5, !taffo.initweight !4, !taffo.info !17
}
