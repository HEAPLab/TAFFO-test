; ModuleID = './function-return.out.1.taffotmp.ll'
...
entry:
  ...
  %call = call float @fun.1(), !taffo.initweight !6, !taffo.info !7, !taffo.originalCall !9
  store float %call, float* %x, align 4, !taffo.initweight !10, !taffo.info !7
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.1() #0 !taffo.initweight !2 !taffo.sourceFunction !9 !taffo.funinfo !2 {
entry:
  %t = alloca float, align 4
  %call = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), float* %t)
  %0 = load float, float* %t, align 4
