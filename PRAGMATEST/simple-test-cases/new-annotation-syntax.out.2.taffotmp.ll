; ModuleID = './new-annotation-syntax.out.1.taffotmp.ll'
...
entry:
  ...
  %t11 = bitcast float* %t1 to i8*, !taffo.initweight !18, !taffo.target !6, !taffo.info !7
  store float 1.230000e+02, float* %t1, align 4, !taffo.initweight !18, !taffo.target !6, !taffo.info !7
  %t22 = bitcast float* %t2 to i8*, !taffo.initweight !18, !taffo.info !7
  store float 1.230000e+02, float* %t2, align 4, !taffo.initweight !18, !taffo.info !7
  %t203 = bitcast float* %t20 to i8*, !taffo.initweight !18, !taffo.info !7
  store float 1.230000e+02, float* %t20, align 4, !taffo.initweight !18, !taffo.info !7
  %t214 = bitcast float* %t21 to i8*, !taffo.initweight !18, !taffo.info !7
  store float 1.230000e+02, float* %t21, align 4, !taffo.initweight !18, !taffo.info !7
  %t2256 = bitcast float* %t225 to i8*, !taffo.initweight !18, !taffo.info !7
  store float 1.230000e+02, float* %t225, align 4, !taffo.initweight !18, !taffo.info !7
  %t237 = bitcast float* %t23 to i8*, !taffo.initweight !18, !taffo.info !7
  store float 1.230000e+02, float* %t23, align 4, !taffo.initweight !18, !taffo.info !7
  %t38 = bitcast float* %t3 to i8*, !taffo.initweight !18, !taffo.target !6, !taffo.info !7
  store float 1.230000e+02, float* %t3, align 4, !taffo.initweight !18, !taffo.target !6, !taffo.info !7
  %t309 = bitcast float* %t30 to i8*, !taffo.initweight !18, !taffo.target !8, !taffo.info !7
  store float 1.230000e+02, float* %t30, align 4, !taffo.initweight !18, !taffo.target !8, !taffo.info !7
  %t3110 = bitcast float* %t31 to i8*, !taffo.initweight !18, !taffo.target !9, !taffo.info !7
  store float 1.230000e+02, float* %t31, align 4, !taffo.initweight !18, !taffo.target !9, !taffo.info !7
  %t411 = bitcast float* %t4 to i8*, !taffo.initweight !18, !taffo.info !10
  store float 1.230000e+02, float* %t4, align 4, !taffo.initweight !18, !taffo.info !10
  %t512 = bitcast float* %t5 to i8*, !taffo.initweight !18, !taffo.info !12
  store float 1.230000e+02, float* %t5, align 4, !taffo.initweight !18, !taffo.info !12
  %t613 = bitcast float* %t6 to i8*, !taffo.initweight !18, !taffo.info !14
  store float 1.230000e+02, float* %t6, align 4, !taffo.initweight !18, !taffo.info !14
  %t714 = bitcast float* %t7 to i8*, !taffo.initweight !18, !taffo.info !16
  store float 1.230000e+02, float* %t7, align 4, !taffo.initweight !18, !taffo.info !16
  ret i32 0
}
