...
entry:
  %add = fadd double 0x3FF3C0CA428C59FB, 0x4002C3F2C52E6BF5, !taffo.initweight !4, !taffo.info !5, !taffo.constinfo !7
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %add), !taffo.initweight !12, !taffo.info !13, !taffo.constinfo !14
  ret i32 0
}
...
!6 = !{double 0x400CA457E67498F2, double 0x400CA457E67498F2}
!7 = !{!8, !10}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0x3FF3C0CA428C59FB, double 0x3FF3C0CA428C59FB}
!10 = !{i1 false, !11, i1 false, i2 0}
!11 = !{double 0x4002C3F2C52E6BF5, double 0x4002C3F2C52E6BF5}
!12 = !{i32 3}
