...
; Function Attrs: noinline nounwind uwtable
define dso_local float @test(i32 %p1, i32 %p2, i32 %p3) #0 !taffo.funinfo !3 !taffo.initweight !4 {
entry:
...
declare !taffo.funinfo !5 !taffo.initweight !6 void @llvm.var.annotation(i8*, i8*, i8*, i32) #1
...
!4 = !{i32 -1, i32 -1, i32 -1}
!5 = !{i32 0, i1 false, i32 0, i1 false, i32 0, i1 false, i32 0, i1 false}
