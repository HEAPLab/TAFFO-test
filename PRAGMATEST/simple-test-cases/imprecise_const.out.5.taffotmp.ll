...
entry:
  %call.flt = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double 0x400CA457E6400000), !taffo.initweight !4, !taffo.info !5, !taffo.constinfo !7
  ret i32 0
}

declare !taffo.initweight !8 !taffo.funinfo !9 dso_local i32 @printf(i8*, ...) #1
