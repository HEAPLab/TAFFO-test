; ModuleID = './phi-and-math.out.4.taffotmp.ll'
...
for.body8:                                        ; preds = %for.cond6
  ...
  %9 = fmul double 0x4160000000000000, %add17, !taffo.constinfo !11, !taffo.info !27
  %10 = fptoui double %9 to i32, !taffo.info !27
  %call25.u9_23fixp = call i32 @clip_rgb.1_u9_23fixp(i32 %10), !taffo.constinfo !26, !taffo.info !27
  %11 = fmul double 0x4160000000000000, %add22, !taffo.constinfo !11, !taffo.info !27
  %12 = fptoui double %11 to i32, !taffo.info !27
  %call26.u9_23fixp = call i32 @clip_rgb.1_u9_23fixp(i32 %12), !taffo.constinfo !26, !taffo.info !27
  ...
  %14 = lshr i32 %call25.u9_23fixp, 23, !taffo.constinfo !26, !taffo.info !29
  ...
  store i32 %14, i32* %g32, align 4, !taffo.info !24
  %15 = lshr i32 %call26.u9_23fixp, 23, !taffo.constinfo !26, !taffo.info !29
  ...
  store i32 %15, i32* %b36, align 4, !taffo.info !24
  ...
  %18 = load i32, i32* %b45, align 4
  %call46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i64 0, i64 0), i32 %16, i32 %17, i32 %18), !taffo.constinfo !6
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @clip_rgb.1_u9_23fixp(i32 %val.u9_23fixp) #0 !taffo.initweight !23 !taffo.funinfo !32 !taffo.sourceFunction !33 {
entry:
  %0 = zext i32 %val.u9_23fixp to i33, !taffo.info !27
  %1 = icmp slt i33 %0, 0, !taffo.info !29
  br i1 %1, label %if.then, label %if.end, !taffo.initweight !34, !taffo.info !24

if.then:                                          ; preds = %entry
  br label %if.end

if.end:                                           ; preds = %entry, %if.then
  %val.addr.0.u9_23fixp = phi i32 [ 0, %if.then ], [ %val.u9_23fixp, %entry ], !taffo.info !29
  %2 = zext i32 %val.addr.0.u9_23fixp to i33, !taffo.info !29
  %3 = icmp sgt i33 %2, 2139095040, !taffo.info !29
  br i1 %3, label %if.then2, label %if.end3, !taffo.initweight !34, !taffo.info !24

if.then2:                                         ; preds = %if.end
  br label %if.end3

if.end3:                                          ; preds = %if.end, %if.then2
  %val.addr.1.u9_23fixp = phi i32 [ 2139095040, %if.then2 ], [ %val.addr.0.u9_23fixp, %if.end ], !taffo.info !29
  ret i32 %val.addr.1.u9_23fixp, !taffo.initweight !35, !taffo.info !24
}
...
!29 = !{!28, i1 false, i1 false, i2 1}
!30 = !{i32 -1, i32 -1, i32 -1, i32 -1}
!31 = !{i32 0, i1 false, i32 0, i1 false, i32 0, i1 false, i32 0, i1 false}
!32 = !{i32 1, !27}
!33 = !{double (double)* @clip_rgb}
!34 = !{i32 6}
!35 = !{i32 5}
