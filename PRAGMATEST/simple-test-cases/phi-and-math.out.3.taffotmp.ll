; ModuleID = './phi-and-math.out.2.taffotmp.ll'
...
for.body8:                                        ; preds = %for.cond6
  ...
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i64 0, i64 0), double %7, double %add17, double %add22), !taffo.initweight !23, !taffo.info !24, !taffo.constinfo !6
  ...
  %call25 = call double @clip_rgb.1(double %add17), !taffo.initweight !23, !taffo.info !24, !taffo.originalCall !27, !taffo.constinfo !26
  %call26 = call double @clip_rgb.2(double %add22), !taffo.initweight !23, !taffo.info !24, !taffo.originalCall !27, !taffo.constinfo !26
  ...
  %conv29 = fptosi double %call25 to i32, !taffo.initweight !23, !taffo.info !24
  ...
  store i32 %conv29, i32* %g32, align 4, !taffo.initweight !28, !taffo.info !24
  %conv33 = fptosi double %call26 to i32, !taffo.initweight !23, !taffo.info !24
  ...
  store i32 %conv33, i32* %b36, align 4, !taffo.initweight !28, !taffo.info !24
...
; Function Attrs: noinline nounwind uwtable
define internal double @clip_rgb.1(double %val) #0 !taffo.initweight !23 !taffo.funinfo !31 !taffo.sourceFunction !27 {
entry:
  %cmp = fcmp olt double %val, 0.000000e+00, !taffo.initweight !32, !taffo.info !24
  br i1 %cmp, label %if.then, label %if.end, !taffo.initweight !33, !taffo.info !24
...
if.end:                                           ; preds = %if.then, %entry
  %val.addr.0 = phi double [ 0.000000e+00, %if.then ], [ %val, %entry ]
  %cmp1 = fcmp ogt double %val.addr.0, 2.550000e+02, !taffo.initweight !32, !taffo.info !24
  br i1 %cmp1, label %if.then2, label %if.end3, !taffo.initweight !33, !taffo.info !24
...
if.end3:                                          ; preds = %if.then2, %if.end
  %val.addr.1 = phi double [ 2.550000e+02, %if.then2 ], [ %val.addr.0, %if.end ]
  ret double %val.addr.1, !taffo.initweight !32, !taffo.info !24
}

; Function Attrs: noinline nounwind uwtable
define internal double @clip_rgb.2(double %val) #0 !taffo.initweight !23 !taffo.funinfo !31 !taffo.sourceFunction !27 {
entry:
  %cmp = fcmp olt double %val, 0.000000e+00, !taffo.initweight !32, !taffo.info !24
  br i1 %cmp, label %if.then, label %if.end, !taffo.initweight !33, !taffo.info !24
