; ModuleID = './inlinetest.out.1.taffotmp.ll'
...
entry:
  ...
  store float %abc, float* %abc.addr, align 4, !taffo.initweight !6, !taffo.info !5
  %abc.addr1 = bitcast float* %abc.addr to i8*, !taffo.initweight !6, !taffo.info !5
  %0 = load float, float* %abc.addr, align 4, !taffo.initweight !6, !taffo.info !5
  %add = fadd float %0, 5.000000e+00, !taffo.initweight !7, !taffo.info !5
  ret float %add, !taffo.initweight !8, !taffo.info !5
}
...
define dso_local i32 @main(i32 %argc, i8** %argv) #2 !taffo.initweight !11 !taffo.funinfo !12 {
entry:
  ...
  %test1 = bitcast float* %test to i8*, !taffo.initweight !6, !taffo.info !5
  store float 1.230000e+02, float* %test, align 4, !taffo.initweight !6, !taffo.info !5
  %0 = load float, float* %test, align 4, !taffo.initweight !6, !taffo.info !5
  store float %0, float* %abc.addr.i, align 4, !taffo.initweight !6, !taffo.info !5
  %abc.addr1.i = bitcast float* %abc.addr.i to i8*, !taffo.initweight !6, !taffo.info !5
  %1 = load float, float* %abc.addr.i, align 4, !taffo.initweight !6, !taffo.info !5
  %add.i = fadd float %1, 5.000000e+00, !taffo.initweight !7, !taffo.info !5
  store float %add.i, float* %test, align 4, !taffo.initweight !6, !taffo.info !5
  %2 = load float, float* %test, align 4, !taffo.initweight !6, !taffo.info !5
  %conv = fpext float %2 to double, !taffo.initweight !7, !taffo.info !5
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv), !taffo.initweight !8, !taffo.info !5
  ret i32 0
}
