...
entry:
  ...
  call void @llvm.var.annotation(i8* %p11, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 15)
  %p22 = bitcast float* %p2 to i8*
  call void @llvm.var.annotation(i8* %p22, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 17)
  %p33 = bitcast float* %p3 to i8*
  call void @llvm.var.annotation(i8* %p33, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 19)
  %sPeak4 = bitcast float* %sPeak to i8*
  call void @llvm.var.annotation(i8* %sPeak4, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 21)
  %sAll5 = bitcast float* %sAll to i8*
  call void @llvm.var.annotation(i8* %sAll5, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 23)
...
land.lhs.true8:                                   ; preds = %land.lhs.true
  ...
  %cmp9 = fcmp ogt float %3, 0.000000e+00
...
if.end14:                                         ; preds = %if.end, %land.lhs.true8, %land.lhs.true, %while.body
  ...
  %add15 = fadd float %12, %11
  store float %add15, float* %sAll, align 4
  ...
  %call17 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %p3)
  br label %while.cond
...
if.then20:                                        ; preds = %while.end
  ...
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), double %conv21)
  br label %if.end24
...
if.then28:                                        ; preds = %if.end24
  ...
  %div30 = fdiv float %20, %conv29
  %conv31 = fpext float %div30 to double
  %call32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), double %conv31)
  br label %if.end35
