...
entry:
  %mul = fmul float 0x41A0000000000000, %param, !taffo.initweight !4, !taffo.info !5, !taffo.constinfo !7
  %conv = sitofp i32 %notafloat to float
  %add = fadd float %mul, %conv, !taffo.initweight !4, !taffo.info !5
  %conv2 = fptosi float %add to i32, !taffo.initweight !4, !taffo.info !5
  %conv3 = sitofp i32 %conv2 to float, !taffo.info !10
  ret float %conv3
}
...
!9 = !{double 0x41A0000000000000, double 0x41A0000000000000}
!10 = !{i1 false, !6, i1 false, i2 0}
