...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main(i32 %argc, i8** %argv) #0 !taffo.start !5 !taffo.initweight !6 !taffo.funinfo !7 {
entry:
  ...
  %call3 = call float @test.1(float %mul), !taffo.initweight !13, !taffo.target !9, !taffo.info !14, !taffo.originalCall !15
  %conv = fpext float %call3 to double, !taffo.initweight !16, !taffo.target !9, !taffo.info !14
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), double %conv), !taffo.initweight !17, !taffo.target !9, !taffo.info !14
  ret i32 0
}
...
; Function Attrs: noinline nounwind uwtable
define internal float @test.1(float %a) #0 !taffo.initweight !13 !taffo.sourceFunction !15 !taffo.funinfo !20 {
entry:
  %mul = fmul float %a, 2.000000e+00, !taffo.initweight !21, !taffo.info !14
  ret float %mul, !taffo.initweight !22, !taffo.info !14
}
