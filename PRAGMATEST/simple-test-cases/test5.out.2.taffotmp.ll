; ModuleID = './test5.out.1.taffotmp.ll'
...
entry:
  ...
  %c = alloca double, align 8, !taffo.initweight !4, !taffo.info !5
  ...
  %c3 = bitcast double* %c to i8*, !taffo.initweight !7, !taffo.info !5
  store double 1.230000e+02, double* %c, align 8, !taffo.initweight !7, !taffo.info !5
  ...
  %1 = load double, double* %c, align 8, !taffo.initweight !7, !taffo.info !5
  %add = fadd double %1, %conv, !taffo.initweight !8, !taffo.info !5
  store double %add, double* %c, align 8, !taffo.initweight !7, !taffo.info !5
  %2 = load double, double* %c, align 8, !taffo.initweight !7, !taffo.info !5
  %conv4 = fptrunc double %2 to float, !taffo.initweight !8, !taffo.info !5
  %conv5 = fpext float %conv4 to double, !taffo.initweight !9, !taffo.info !5
  %3 = load double, double* %b.addr, align 8, !taffo.initweight !7, !taffo.info !5
  %add6 = fadd double %conv5, %3, !taffo.initweight !8, !taffo.info !5
  %conv7 = fptrunc double %add6 to float, !taffo.initweight !9, !taffo.info !5
  ret float %conv7, !taffo.initweight !10, !taffo.info !5
}
