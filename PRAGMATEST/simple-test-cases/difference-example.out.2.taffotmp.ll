; ModuleID = './difference-example.out.1.taffotmp.ll'
...
entry:
  ...
  %a1 = bitcast double* %a to i8*, !taffo.initweight !5, !taffo.info !4
  ...
  store double %mul, double* %a, align 8, !taffo.initweight !5, !taffo.info !4
  %3 = load double, double* %a, align 8, !taffo.initweight !5, !taffo.info !4
  ret double %3, !taffo.initweight !6, !taffo.info !4
}

; Function Attrs: nounwind willreturn
declare !taffo.initweight !7 !taffo.funinfo !8 void @llvm.var.annotation(i8*, i8*, i8*, i32) #1

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main(i32 %argc, i8** %argv) #0 !taffo.initweight !9 !taffo.funinfo !10 {
entry:
...
!2 = !{}
!3 = !{i32 0}
!4 = !{i1 false, i1 false, i1 false, i2 1}
!5 = !{i32 1}
!6 = !{i32 2}
