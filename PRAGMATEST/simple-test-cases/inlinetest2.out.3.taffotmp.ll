...
entry:
  %test = alloca [10 x float], align 16, !taffo.initweight !15, !taffo.info !16
  %test1 = bitcast [10 x float]* %test to i8*, !taffo.initweight !18, !taffo.info !16
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %test, i64 0, i64 %idxprom, !taffo.initweight !18, !taffo.info !16
...
for.end:                                          ; preds = %for.cond
  %arraydecay = getelementptr inbounds [10 x float], [10 x float]* %test, i64 0, i64 0, !taffo.initweight !18, !taffo.info !16
  %arrayidx.i = getelementptr inbounds float, float* %arraydecay, i64 5, !taffo.initweight !4, !taffo.info !16
  ...
  %arrayidx2 = getelementptr inbounds [10 x float], [10 x float]* %test, i64 0, i64 5, !taffo.initweight !18, !taffo.info !16
  %1 = load float, float* %arrayidx2, align 4, !taffo.initweight !4, !taffo.info !16
  %conv = fpext float %1 to double, !taffo.initweight !6, !taffo.info !16
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv), !taffo.initweight !7, !taffo.info !5, !taffo.constinfo !34
  ret i32 0
}
...
!17 = !{double 1.230000e+02, double 1.280000e+02}
!18 = !{i32 1}
