; ModuleID = './array3.out.1.taffotmp.ll'
...
entry:
  %call = call i32 @clock_gettime(i32 4, %struct.timespec* getelementptr inbounds (%struct.anon, %struct.anon* @timer_state, i32 0, i32 0)) #4
  ret void
}
...
entry:
  ...
  %call = call i32 @clock_gettime(i32 4, %struct.timespec* %etime) #4
...
entry:
  ...
  %buf1 = bitcast [524288 x float]* %buf to i8*, !taffo.initweight !8, !taffo.info !6
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom, !taffo.initweight !8, !taffo.info !6
  store float %conv3, float* %arrayidx, align 4, !taffo.initweight !9, !taffo.info !6
  br label %for.inc
...
for.body13:                                       ; preds = %for.cond10
  ...
  %arrayidx15 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom14, !taffo.initweight !8, !taffo.info !6
  %6 = load float, float* %arrayidx15, align 4, !taffo.initweight !9, !taffo.info !6
  %7 = load i32, i32* %i9, align 4
  %add = add nsw i32 %7, 1
  %idxprom16 = sext i32 %add to i64
  %arrayidx17 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom16, !taffo.initweight !8, !taffo.info !6
  %8 = load float, float* %arrayidx17, align 4, !taffo.initweight !9, !taffo.info !6
  %add18 = fadd float %6, %8, !taffo.initweight !10, !taffo.info !6
  %9 = load i32, i32* %i9, align 4
  %idxprom19 = sext i32 %9 to i64
  %arrayidx20 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom19, !taffo.initweight !8, !taffo.info !6
  store float %add18, float* %arrayidx20, align 4, !taffo.initweight !9, !taffo.info !6
  br label %for.inc21
...
for.end23:                                        ; preds = %for.cond10
  %sync24 = bitcast float* %sync to i8*, !taffo.initweight !8, !taffo.info !6
  %sync25 = bitcast float* %sync to i8*, !taffo.initweight !8, !taffo.info !6
  store float 0.000000e+00, float* %sync, align 4, !taffo.initweight !8, !taffo.info !6
...
for.body30:                                       ; preds = %for.cond27
  ...
  %arrayidx32 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom31, !taffo.initweight !8, !taffo.info !6
  %13 = load float, float* %arrayidx32, align 4, !taffo.initweight !9, !taffo.info !6
  %14 = load float, float* %sync, align 4, !taffo.initweight !8, !taffo.info !6
  %add33 = fadd float %14, %13, !taffo.initweight !9, !taffo.info !6
  store float %add33, float* %sync, align 4, !taffo.initweight !8, !taffo.info !6
  br label %for.inc34
...
for.body60:                                       ; preds = %for.cond57
  ...
  %arrayidx69 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom68, !taffo.initweight !8, !taffo.info !6
  store float %conv67, float* %arrayidx69, align 4, !taffo.initweight !9, !taffo.info !6
  br label %for.inc70
...
for.body84:                                       ; preds = %for.cond81
  ...
  %arrayidx86 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom85, !taffo.initweight !8, !taffo.info !6
  %32 = load float, float* %arrayidx86, align 4, !taffo.initweight !9, !taffo.info !6
  %33 = load i32, i32* %i80, align 4
  %add87 = add nsw i32 %33, 1
  %idxprom88 = sext i32 %add87 to i64
  %arrayidx89 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom88, !taffo.initweight !8, !taffo.info !6
  %34 = load float, float* %arrayidx89, align 4, !taffo.initweight !9, !taffo.info !6
  %mul = fmul float %32, %34, !taffo.initweight !10, !taffo.info !6
  %35 = load i32, i32* %i80, align 4
  %idxprom90 = sext i32 %35 to i64
  %arrayidx91 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom90, !taffo.initweight !8, !taffo.info !6
  store float %mul, float* %arrayidx91, align 4, !taffo.initweight !9, !taffo.info !6
  br label %for.inc92
...
for.end94:                                        ; preds = %for.cond81
  %sync9596 = bitcast float* %sync95 to i8*, !taffo.initweight !8, !taffo.info !6
  %sync9597 = bitcast float* %sync95 to i8*, !taffo.initweight !8, !taffo.info !6
  store float 0.000000e+00, float* %sync95, align 4, !taffo.initweight !8, !taffo.info !6
...
for.body102:                                      ; preds = %for.cond99
  ...
  %arrayidx104 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom103, !taffo.initweight !8, !taffo.info !6
  %39 = load float, float* %arrayidx104, align 4, !taffo.initweight !9, !taffo.info !6
  %40 = load float, float* %sync95, align 4, !taffo.initweight !8, !taffo.info !6
  %add105 = fadd float %40, %39, !taffo.initweight !9, !taffo.info !6
  store float %add105, float* %sync95, align 4, !taffo.initweight !8, !taffo.info !6
  br label %for.inc106
...
declare !taffo.initweight !11 !taffo.funinfo !12 void @llvm.var.annotation(i8*, i8*, i8*, i32) #2

declare !taffo.initweight !13 !taffo.funinfo !14 dso_local i32 @printf(i8*, ...) #3
