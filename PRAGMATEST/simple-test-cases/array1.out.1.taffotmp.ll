...
entry:
  ...
  call void @llvm.var.annotation(i8* %numbers1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 10)
...
for.end:                                          ; preds = %if.then, %for.cond
  ...
  call void @llvm.var.annotation(i8* %add5, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 22)
  store float 0.000000e+00, float* %add, align 4
  %sub6 = bitcast float* %sub to i8*
  call void @llvm.var.annotation(i8* %sub6, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 24)
  store float 0.000000e+00, float* %sub, align 4
  %div7 = bitcast float* %div to i8*
  call void @llvm.var.annotation(i8* %div7, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 26)
  store float 1.000000e+00, float* %div, align 4
  %mul8 = bitcast float* %mul to i8*
  call void @llvm.var.annotation(i8* %mul8, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 28)
...
for.end33:                                        ; preds = %for.cond10
  ...
  %call38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.5, i64 0, i64 0), double %conv34, double %conv35, double %conv36, double %conv37)
  ret i32 0
}
