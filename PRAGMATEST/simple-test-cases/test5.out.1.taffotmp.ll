...
define dso_local float @fpextfptrunc(float %a, double %b) #0 {
entry:
  ...
  call void @llvm.var.annotation(i8* %a.addr1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 4)
  store double %b, double* %b.addr, align 8
  %b.addr2 = bitcast double* %b.addr to i8*
  call void @llvm.var.annotation(i8* %b.addr2, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 4)
  %c3 = bitcast double* %c to i8*
  call void @llvm.var.annotation(i8* %c3, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 7)
