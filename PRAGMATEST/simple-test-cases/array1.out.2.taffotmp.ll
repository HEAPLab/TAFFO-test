...
entry:
  ...
  %tmp = alloca float, align 4, !taffo.initweight !4, !taffo.info !6
  %i = alloca i32, align 4
  %add = alloca float, align 4, !taffo.initweight !4, !taffo.info !5
  %sub = alloca float, align 4, !taffo.initweight !4, !taffo.info !5
  %div = alloca float, align 4, !taffo.initweight !4, !taffo.info !8
  %mul = alloca float, align 4, !taffo.initweight !4, !taffo.info !5
  %i9 = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  store i32 %argc, i32* %argc.addr, align 4
  store i8** %argv, i8*** %argv.addr, align 8
  %numbers1 = bitcast [30 x float]* %numbers to i8*, !taffo.initweight !9, !taffo.info !5
  store i32 0, i32* %n, align 4
  %tmp2 = bitcast float* %tmp to i8*, !taffo.initweight !9, !taffo.info !6
...
for.body:                                         ; preds = %for.cond
  %call = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %tmp), !taffo.initweight !9, !taffo.info !6
  %cmp3 = icmp slt i32 %call, 1, !taffo.initweight !10, !taffo.info !6
  br i1 %cmp3, label %if.then, label %if.end, !taffo.initweight !11, !taffo.info !6

if.then:                                          ; preds = %for.body
  br label %for.end

if.end:                                           ; preds = %for.body
  %1 = load float, float* %tmp, align 4, !taffo.initweight !9, !taffo.info !6
  ...
  store float %1, float* %arrayidx, align 4, !taffo.initweight !10, !taffo.info !5
  br label %for.inc
...
for.end:                                          ; preds = %if.then, %for.cond
  %add5 = bitcast float* %add to i8*, !taffo.initweight !9, !taffo.info !5
  store float 0.000000e+00, float* %add, align 4, !taffo.initweight !9, !taffo.info !5
  %sub6 = bitcast float* %sub to i8*, !taffo.initweight !9, !taffo.info !5
  store float 0.000000e+00, float* %sub, align 4, !taffo.initweight !9, !taffo.info !5
  %div7 = bitcast float* %div to i8*, !taffo.initweight !9, !taffo.info !8
  store float 1.000000e+00, float* %div, align 4, !taffo.initweight !9, !taffo.info !8
  %mul8 = bitcast float* %mul to i8*, !taffo.initweight !9, !taffo.info !5
  store float 1.000000e+00, float* %mul, align 4, !taffo.initweight !9, !taffo.info !5
...
for.body12:                                       ; preds = %for.cond10
  ...
  %7 = load float, float* %arrayidx14, align 4, !taffo.initweight !10, !taffo.info !5
  %8 = load float, float* %add, align 4, !taffo.initweight !9, !taffo.info !5
  %add15 = fadd float %8, %7, !taffo.initweight !10, !taffo.info !5
  store float %add15, float* %add, align 4, !taffo.initweight !9, !taffo.info !5
  ...
  %10 = load float, float* %arrayidx17, align 4, !taffo.initweight !10, !taffo.info !5
  %11 = load float, float* %sub, align 4, !taffo.initweight !9, !taffo.info !5
  %sub18 = fsub float %11, %10, !taffo.initweight !10, !taffo.info !5
  store float %sub18, float* %sub, align 4, !taffo.initweight !9, !taffo.info !5
  ...
  %13 = load float, float* %arrayidx20, align 4, !taffo.initweight !10, !taffo.info !5
  %conv = fpext float %13 to double, !taffo.initweight !11, !taffo.info !5
  %cmp21 = fcmp une double %conv, 0.000000e+00, !taffo.initweight !12, !taffo.info !5
  br i1 %cmp21, label %if.then23, label %if.end27, !taffo.initweight !13, !taffo.info !5
...
if.then23:                                        ; preds = %for.body12
  ...
  %15 = load float, float* %arrayidx25, align 4, !taffo.initweight !10, !taffo.info !5
  %16 = load float, float* %div, align 4, !taffo.initweight !9, !taffo.info !8
  %div26 = fdiv float %16, %15, !taffo.initweight !10, !taffo.info !8
  store float %div26, float* %div, align 4, !taffo.initweight !9, !taffo.info !8
  br label %if.end27
...
if.end27:                                         ; preds = %if.then23, %for.body12
  ...
  %18 = load float, float* %arrayidx29, align 4, !taffo.initweight !10, !taffo.info !5
  %19 = load float, float* %mul, align 4, !taffo.initweight !9, !taffo.info !5
  %mul30 = fmul float %19, %18, !taffo.initweight !10, !taffo.info !5
  store float %mul30, float* %mul, align 4, !taffo.initweight !9, !taffo.info !5
  br label %for.inc31
...
for.end33:                                        ; preds = %for.cond10
  ...
  %conv34 = fpext float %21 to double, !taffo.initweight !10, !taffo.info !5
  %22 = load float, float* %sub, align 4, !taffo.initweight !9, !taffo.info !5
  %conv35 = fpext float %22 to double, !taffo.initweight !10, !taffo.info !5
  %23 = load float, float* %div, align 4, !taffo.initweight !9, !taffo.info !8
  %conv36 = fpext float %23 to double, !taffo.initweight !10, !taffo.info !8
  %24 = load float, float* %mul, align 4, !taffo.initweight !9, !taffo.info !5
  %conv37 = fpext float %24 to double, !taffo.initweight !10, !taffo.info !5
  %call38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.5, i64 0, i64 0), double %conv34, double %conv35, double %conv36, double %conv37), !taffo.initweight !11, !taffo.info !5
  ret i32 0
}
