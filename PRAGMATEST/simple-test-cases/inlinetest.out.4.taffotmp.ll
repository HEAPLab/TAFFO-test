...
entry:
  %add.i = fadd float 1.230000e+02, 5.000000e+00, !taffo.initweight !4, !taffo.info !12, !taffo.constinfo !15
  %conv = fpext float %add.i to double, !taffo.initweight !4, !taffo.info !12
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv), !taffo.initweight !9, !taffo.info !18, !taffo.constinfo !19
  ret i32 0
}
...
!17 = !{double 1.230000e+02, double 1.230000e+02}
!18 = !{!13, i1 false, i1 false, i2 1}
