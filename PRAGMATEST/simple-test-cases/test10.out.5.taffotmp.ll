...
entry:
  %conv = fpext float 1.200000e+01 to double, !taffo.info !4
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), double %conv), !taffo.constinfo !6
  ret i32 0
}
...
!5 = !{double 1.200000e+01, double 1.200000e+01}
