...
entry:
  ...
  store float %0, float* %a2, align 4, !taffo.initweight !12, !taffo.info !6
  ...
  store i32 %conv, i32* %b3, align 4, !taffo.initweight !12, !taffo.info !11
  %2 = load float, float* %c, align 4
  %c4 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 2, !taffo.initweight !10, !taffo.info !8
  store float %2, float* %c4, align 4, !taffo.initweight !12, !taffo.info !8
  %a5 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 0, !taffo.initweight !10, !taffo.info !6
  %3 = load float, float* %a5, align 4, !taffo.initweight !12, !taffo.info !6
  %conv6 = fpext float %3 to double, !taffo.initweight !13, !taffo.info !6
  %b7 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 1, !taffo.initweight !10, !taffo.info !11
  %4 = load i32, i32* %b7, align 4, !taffo.initweight !12, !taffo.info !11
  %c8 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 2, !taffo.initweight !10, !taffo.info !8
  %5 = load float, float* %c8, align 4, !taffo.initweight !12, !taffo.info !8
  %conv9 = fpext float %5 to double, !taffo.initweight !13, !taffo.info !8
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), double %conv6, i32 %4, double %conv9), !taffo.initweight !13, !taffo.info !11
  ret i32 0
}
