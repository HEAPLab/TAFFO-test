; ModuleID = './test6.out.2.taffotmp.ll'
...
entry:
  ...
  %arrayidx = getelementptr inbounds float, float* %arraydecay, i64 5, !taffo.initweight !8, !taffo.info !5
  store float %conv, float* %arrayidx, align 4, !taffo.initweight !9, !taffo.info !5
  %arrayidx3 = getelementptr inbounds float, float* %arraydecay, i64 5, !taffo.initweight !8, !taffo.info !5
  %0 = load float, float* %arrayidx3, align 4, !taffo.initweight !9, !taffo.info !5
  ret float %0, !taffo.initweight !10, !taffo.info !5
}
