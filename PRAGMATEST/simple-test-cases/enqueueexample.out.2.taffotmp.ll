; ModuleID = './enqueueexample.out.1.taffotmp.ll'
...
define dso_local float @example(float %a, float %b, float %c, float %d) #0 !taffo.funinfo !2 !taffo.initweight !3 {
entry:
  ...
  call void @llvm.var.annotation(i8* %y1, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 9)
...
declare !taffo.funinfo !2 !taffo.initweight !3 void @llvm.var.annotation(i8*, i8*, i8*, i32) #1

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main(i32 %argc, i8** %argv) #0 !taffo.funinfo !4 !taffo.initweight !5 {
entry:
...
declare !taffo.funinfo !6 !taffo.initweight !7 dso_local i32 @printf(i8*, ...) #2
...
!2 = !{i32 0, i1 false, i32 0, i1 false, i32 0, i1 false, i32 0, i1 false}
