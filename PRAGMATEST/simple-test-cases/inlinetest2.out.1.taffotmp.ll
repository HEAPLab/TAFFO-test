...
entry:
  ...
  call void @llvm.var.annotation(i8* %abc.addr1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 5)
...
entry:
  ...
  call void @llvm.var.annotation(i8* %test1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 13)
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.var.annotation(i8* %abc.addr1.i, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 5) #4
  ...
  %add.i = fadd float %4, 5.000000e+00
