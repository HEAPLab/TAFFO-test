...
define dso_local void @timerStart() #0 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define dso_local i64 @timerStop() #0 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define dso_local i64 @xorshift64star() #0 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @randomInRange(i32 %a, i32 %b) #0 {
entry:
...
entry:
  ...
  %buf = alloca [524288 x float], align 16
  ...
  %buf1 = bitcast [524288 x float]* %buf to i8*
  call void @llvm.var.annotation(i8* %buf1, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 134)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom
...
for.body13:                                       ; preds = %for.cond10
  ...
  %arrayidx15 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom14
  %6 = load float, float* %arrayidx15, align 4
  %7 = load i32, i32* %i9, align 4
  %add = add nsw i32 %7, 1
  %idxprom16 = sext i32 %add to i64
  %arrayidx17 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom16
  %8 = load float, float* %arrayidx17, align 4
  %add18 = fadd float %6, %8
  %9 = load i32, i32* %i9, align 4
  %idxprom19 = sext i32 %9 to i64
  %arrayidx20 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom19
...
for.end23:                                        ; preds = %for.cond10
  %sync24 = bitcast float* %sync to i8*
  call void @llvm.var.annotation(i8* %sync24, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 139)
  %sync25 = bitcast float* %sync to i8*
  call void @llvm.var.annotation(i8* %sync25, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 139)
...
for.body30:                                       ; preds = %for.cond27
  ...
  %arrayidx32 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom31
  %13 = load float, float* %arrayidx32, align 4
  %14 = load float, float* %sync, align 4
  %add33 = fadd float %14, %13
  store float %add33, float* %sync, align 4
  br label %for.inc34
...
for.body60:                                       ; preds = %for.cond57
  ...
  %arrayidx69 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom68
  store float %conv67, float* %arrayidx69, align 4
  br label %for.inc70
...
for.body84:                                       ; preds = %for.cond81
  ...
  %arrayidx86 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom85
  %32 = load float, float* %arrayidx86, align 4
  %33 = load i32, i32* %i80, align 4
  %add87 = add nsw i32 %33, 1
  %idxprom88 = sext i32 %add87 to i64
  %arrayidx89 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom88
  %34 = load float, float* %arrayidx89, align 4
  %mul = fmul float %32, %34
  %35 = load i32, i32* %i80, align 4
  %idxprom90 = sext i32 %35 to i64
  %arrayidx91 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom90
...
for.end94:                                        ; preds = %for.cond81
  %sync9596 = bitcast float* %sync95 to i8*
  call void @llvm.var.annotation(i8* %sync9596, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 144)
  %sync9597 = bitcast float* %sync95 to i8*
  call void @llvm.var.annotation(i8* %sync9597, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 144)
  store float 0.000000e+00, float* %sync95, align 4
...
for.body102:                                      ; preds = %for.cond99
  ...
  %arrayidx104 = getelementptr inbounds [524288 x float], [524288 x float]* %buf, i64 0, i64 %idxprom103
  %39 = load float, float* %arrayidx104, align 4
  %40 = load float, float* %sync95, align 4
  %add105 = fadd float %40, %39
  store float %add105, float* %sync95, align 4
  br label %for.inc106
