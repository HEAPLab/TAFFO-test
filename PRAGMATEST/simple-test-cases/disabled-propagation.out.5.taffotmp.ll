...
entry:
  %call.flt = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double 0.000000e+00), !taffo.initweight !4, !taffo.info !5, !taffo.constinfo !7
  %call8.flt = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double 4.000000e+00), !taffo.initweight !4, !taffo.info !8, !taffo.constinfo !7
  ret i32 0
}
