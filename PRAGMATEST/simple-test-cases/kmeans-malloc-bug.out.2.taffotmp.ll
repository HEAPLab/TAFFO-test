; ModuleID = './kmeans-malloc-bug.out.1.taffotmp.ll'
...
entry:
  ...
  store i32 10, i32* %w, align 8, !taffo.initweight !13, !taffo.info !12
  %h = getelementptr inbounds %struct.RgbImage, %struct.RgbImage* %image, i32 0, i32 1, !taffo.initweight !11, !taffo.info !12
  store i32 20, i32* %h, align 4, !taffo.initweight !13, !taffo.info !12
  ...
  %conv = sext i32 %0 to i64, !taffo.initweight !14, !taffo.info !12
  %mul = mul i64 %conv, 8, !taffo.initweight !15, !taffo.info !12
  %call = call noalias i8* @malloc(i64 %mul) #3, !taffo.initweight !16, !taffo.info !12
  %1 = bitcast i8* %call to %struct.RgbPixel**, !taffo.initweight !17, !taffo.structinfo !18
...
!16 = !{i32 5}
!17 = !{i32 6}
!18 = !{i1 false, i1 false, i1 false, i1 false, i1 false}
