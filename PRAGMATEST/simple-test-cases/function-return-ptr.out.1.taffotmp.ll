; ModuleID = './function-return-ptr.c'
source_filename = "./function-return-ptr.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@glob = common dso_local global float 0.000000e+00, align 4
...
entry:
  ...
  call void @llvm.var.annotation(i8* %x1, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i32 17)
  %call = call float* @fun()
  store float* %call, float** %x, align 8
  %t2 = bitcast float* %t to i8*
  call void @llvm.var.annotation(i8* %t2, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i32 19)
  %call3 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), float* %t)
  %0 = load float, float* %t, align 4
  %1 = load float*, float** %x, align 8
  store float %0, float* %1, align 4
  %2 = load float*, float** %x, align 8
  %3 = load float, float* %2, align 4
  %conv = fpext float %3 to double
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), double %conv)
  ret i32 0
}
