; ModuleID = './malloc.out.2.taffotmp.ll'
source_filename = "./malloc.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [21 x i8] c"scalar(range(-1, 1))\00", section "llvm.metadata"
...
entry:
  ...
  %call = call noalias i8* @malloc(i64 40) #4, !taffo.constinfo !4
...
for.body:                                         ; preds = %for.cond
  ...
  store float %1, float* %arrayidx, align 4, !taffo.initweight !15, !taffo.info !13
  ...
  %2 = load float, float* %arrayidx4, align 4, !taffo.initweight !15, !taffo.info !13
  %conv = fpext float %2 to double, !taffo.initweight !16, !taffo.info !13
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double %conv), !taffo.initweight !17, !taffo.info !13, !taffo.constinfo !9
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !18, !taffo.constinfo !4
  br label %for.cond
...
declare !taffo.initweight !22 !taffo.funinfo !23 dso_local i32 @__isoc99_scanf(i8*, ...) #3

declare !taffo.initweight !22 !taffo.funinfo !23 dso_local i32 @printf(i8*, ...) #3
...
!19 = !{double 1.000000e+00, double 1.100000e+01}
