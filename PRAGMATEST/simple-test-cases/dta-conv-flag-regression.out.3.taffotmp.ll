; ModuleID = './dta-conv-flag-regression.out.2.taffotmp.ll'
...
entry:
  ...
  %call2 = call double @cos2.1(double %0), !taffo.initweight !20, !taffo.info !21, !taffo.originalCall !23, !taffo.constinfo !11
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), double %call2), !taffo.initweight !24, !taffo.info !21, !taffo.constinfo !19
  ret i32 0
}
...
declare !taffo.initweight !25 !taffo.funinfo !26 void @llvm.var.annotation(i8*, i8*, i8*, i32) #2

declare !taffo.initweight !2 !taffo.funinfo !4 dso_local i32 @printf(i8*, ...) #1

; Function Attrs: noinline nounwind uwtable
define internal double @cos2.1(double %angle) #0 !taffo.initweight !20 !taffo.funinfo !27 !taffo.sourceFunction !23 {
entry:
  %call = call double @normalizeRadiantForCosine.2(double %angle), !taffo.initweight !28, !taffo.info !21, !taffo.originalCall !29, !taffo.constinfo !11
  ...
  %conv = fptosi double %add to i32, !taffo.initweight !32, !taffo.info !21
  %idxprom = sext i32 %conv to i64
  %arrayidx = getelementptr inbounds [5 x double], [5 x double]* @cosTable, i64 0, i64 %idxprom
  %0 = load double, double* %arrayidx, align 8
  ret double %0
...
entry:
  %cmp = fcmp olt double %angle, 0.000000e+00, !taffo.initweight !32, !taffo.info !33
  br i1 %cmp, label %if.then, label %if.end, !taffo.initweight !34, !taffo.info !21
...
while.cond:                                       ; preds = %while.body, %if.end
  %angle.addr.1 = phi double [ %angle.addr.0, %if.end ], [ %sub, %while.body ]
  %cmp1 = fcmp oge double %angle.addr.1, 0x401921FB54442D18, !taffo.initweight !32, !taffo.info !33
  br i1 %cmp1, label %while.body, label %while.end, !taffo.initweight !34, !taffo.info !21
...
while.end:                                        ; preds = %while.cond
  ret double %angle.addr.1, !taffo.initweight !32, !taffo.info !21
}
