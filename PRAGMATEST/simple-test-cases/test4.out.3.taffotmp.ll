...
if.then7:                                         ; preds = %cond.end
  ...
  %add = fadd double %conv, 8.000000e-01, !taffo.info !25, !taffo.constinfo !27
...
if.else9:                                         ; preds = %cond.end
  ...
  %add11 = fadd double %conv10, 3.000000e-01, !taffo.info !32, !taffo.constinfo !34
...
!26 = !{double 1.800000e+00, double 0x4002666676666666}
!27 = !{i1 false, !28}
...
!33 = !{double 1.300000e+00, double 0x3FF800000CCCCCCD}
!34 = !{i1 false, !35}
!35 = !{i1 false, !36, i1 false, i2 0}
!36 = !{double 3.000000e-01, double 3.000000e-01}
