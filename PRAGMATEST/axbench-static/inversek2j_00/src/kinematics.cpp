...
#pragma taffo l1 "scalar(range(0.5,0.5) error(1e-8))"
#pragma taffo l2 "scalar(range(0.5,0.5) error(1e-8))"
float  l1 = 0.5 ;
float  l2 = 0.5 ;
...
*/
	#pragma taffo sqtmp inversek2j "scalar(range(0.5,4.934802) final)"
	float sqtmp = (x * x + y * y);
