...
{                                                                              \
              ...
              if (sub1 >= 0.0f)                                                \
              {                                                                \
                _Pragma("taffo adj1 tri_tri_intersect \"scalar(range(1e+2,768000000) final)\"") \
                float adj1 = sub1;                                             \
              ...
              if (sub2 >= 0.0f)                                                \
              {                                                                \
                _Pragma("taffo adj2 tri_tri_intersect \"scalar(range(1e+2,768000000) final)\"") \
                float adj2 = sub2;                                             \
...
int coplanar_tri_tri(float N[3],
		     ...
		     float U2[3])
{
   #pragma taffo A coplanar_tri_tri "scalar()"
   float A[3];
   short i0,i1;
		      ...
		      float *res, int *output)
{
  ...
  #pragma taffo U0  tri_tri_intersect "scalar()"
  #pragma taffo U1  tri_tri_intersect "scalar()"
  #pragma taffo U2  tri_tri_intersect "scalar()"
  #pragma taffo res tri_tri_intersect "scalar()"



  #pragma taffo E1     tri_tri_intersect "scalar()"
  #pragma taffo E2     tri_tri_intersect "scalar()"
  #pragma taffo N1     tri_tri_intersect "scalar()"
  #pragma taffo N2     tri_tri_intersect "scalar()"
  #pragma taffo d1     tri_tri_intersect "scalar()"
  #pragma taffo d2     tri_tri_intersect "scalar()"
  #pragma taffo du0    tri_tri_intersect "scalar()"
  #pragma taffo du1    tri_tri_intersect "scalar()"
  #pragma taffo du2    tri_tri_intersect "scalar()"
  #pragma taffo dv0    tri_tri_intersect "scalar()"
  #pragma taffo dv1    tri_tri_intersect "scalar()"
  #pragma taffo dv2    tri_tri_intersect "scalar()"
  #pragma taffo D      tri_tri_intersect "scalar()"
  #pragma taffo isect1 tri_tri_intersect "scalar()"
  #pragma taffo isect2 tri_tri_intersect "scalar()"
  #pragma taffo vp0    tri_tri_intersect "scalar()"
  #pragma taffo vp1    tri_tri_intersect "scalar()"
  #pragma taffo vp2    tri_tri_intersect "scalar()"
  #pragma taffo up0    tri_tri_intersect "scalar()"
  #pragma taffo up1    tri_tri_intersect "scalar()"
  ...
  *output = 3;
  ...
  res[0] = isect1[0];
  res[1] = isect1[1];
  #pragma taffo delta_isect_1 tri_tri_intersect "errtarget('delta_isect_1') scalar()"
  #pragma taffo delta_isect_2 tri_tri_intersect "errtarget('delta_isect_2') scalar()"
