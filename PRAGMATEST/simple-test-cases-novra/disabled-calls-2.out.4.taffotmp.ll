...
entry:
  ...
  %call3 = call float @test.1(float %mul), !taffo.initweight !13, !taffo.target !9, !taffo.info !14, !taffo.originalCall !17
  %conv = fpext float %call3 to double, !taffo.initweight !18, !taffo.target !9, !taffo.info !14
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), double %conv), !taffo.initweight !19, !taffo.target !9, !taffo.info !20
  ret i32 0
}
...
; Function Attrs: noinline nounwind uwtable
define internal float @test.1(float %a) #0 !taffo.initweight !13 !taffo.funinfo !21 !taffo.sourceFunction !17 {
entry:
  %mul = fmul float %a, 2.000000e+00, !taffo.initweight !22, !taffo.info !14
  ret float %mul, !taffo.initweight !23, !taffo.info !24
}
