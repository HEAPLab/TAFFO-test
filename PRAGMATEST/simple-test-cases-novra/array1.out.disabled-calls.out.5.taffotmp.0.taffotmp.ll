; ModuleID = './disabled-calls.out.5.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal float @test.1(float %a) #0 !taffo.initweight !13 !taffo.funinfo !17 !taffo.sourceFunction !14 {
entry:
  ...
  %mul = fmul float %0, 2.000000e+00, !taffo.initweight !18, !taffo.info !10
  ret float %mul, !taffo.initweight !19, !taffo.info !10
}
