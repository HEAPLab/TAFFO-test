...
@vec = common dso_local global [10 x double] zeroinitializer, align 16
@scal = common dso_local global double 0.000000e+00, align 8
...
for.body5:                                        ; preds = %for.cond2
  ...
  %mul = fmul double %6, %7
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double %mul)
  br label %for.inc8
