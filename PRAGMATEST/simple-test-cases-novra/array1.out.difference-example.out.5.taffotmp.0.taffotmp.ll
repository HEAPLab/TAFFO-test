; ModuleID = './difference-example.out.5.taffotmp.ll'
...
entry:
  %a.s8_24fixp = alloca i32, align 8, !taffo.info !3
  ...
  %3 = fmul double 0x4170000000000000, %mul, !taffo.info !6
  %4 = fptosi double %3 to i32, !taffo.info !6
  store i32 %4, i32* %a.s8_24fixp, align 8, !taffo.info !6
  %s8_24fixp = load i32, i32* %a.s8_24fixp, align 8, !taffo.info !3
  %5 = sitofp i32 %s8_24fixp to double, !taffo.info !3
  %6 = fdiv double %5, 0x4170000000000000, !taffo.info !3
  ret double %6, !taffo.initweight !7, !taffo.info !6
}
