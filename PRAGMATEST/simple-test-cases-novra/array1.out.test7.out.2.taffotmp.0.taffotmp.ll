; ModuleID = './test7.out.2.taffotmp.ll'
...
entry:
  ...
  %b1 = bitcast float** %b to i8*, !taffo.initweight !9, !taffo.info !7
  %arraydecay = getelementptr inbounds [10 x float], [10 x float]* %c, i64 0, i64 0, !taffo.initweight !10, !taffo.info !5
  store float* %arraydecay, float** %b, align 8, !taffo.initweight !9, !taffo.info !7
  %0 = load i32, i32* %a.addr, align 4
  %conv = sitofp i32 %0 to float, !taffo.initweight !11, !taffo.info !7
  %1 = load float*, float** %b, align 8, !taffo.initweight !9, !taffo.info !7
  %arrayidx = getelementptr inbounds float, float* %1, i64 5, !taffo.initweight !10, !taffo.info !7
  store float %conv, float* %arrayidx, align 4, !taffo.initweight !4, !taffo.info !7
  %2 = load float*, float** %b, align 8, !taffo.initweight !9, !taffo.info !7
  %arrayidx2 = getelementptr inbounds float, float* %2, i64 5, !taffo.initweight !10, !taffo.info !7
  %3 = load float, float* %arrayidx2, align 4, !taffo.initweight !4, !taffo.info !7
  ret float %3, !taffo.initweight !11, !taffo.info !7
}
