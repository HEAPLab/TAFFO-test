; ModuleID = './test9.out.5.taffotmp.ll'
...
entry:
  ...
  %cake.s16_16fixp = alloca i32, align 4, !taffo.info !4
  ...
  %2 = shl i32 %add, 16, !taffo.info !7
  store i32 %2, i32* %cake.s16_16fixp, align 4, !taffo.info !7
  %s16_16fixp = load i32, i32* %cake.s16_16fixp, align 4, !taffo.info !4
  %3 = load float, float* %cherry.addr, align 4
  %4 = fmul float 6.553600e+04, %3, !taffo.info !4
  %5 = fptosi float %4 to i32, !taffo.info !4
  %add2.s16_16fixp = add i32 %s16_16fixp, %5, !taffo.info !4
  %6 = sitofp i32 %add2.s16_16fixp to float, !taffo.info !4
  %7 = fdiv float %6, 6.553600e+04, !taffo.info !4
  ret float %7, !taffo.initweight !8, !taffo.info !7
}
