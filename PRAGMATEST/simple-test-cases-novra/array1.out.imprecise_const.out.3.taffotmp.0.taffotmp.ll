; ModuleID = './imprecise_const.out.3.taffotmp.ll'
source_filename = "./imprecise_const.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [10 x i8] c"range 0 4\00", section "llvm.metadata"
...
entry:
  ...
  %magic1 = bitcast double* %magic to i8*, !taffo.initweight !7, !taffo.info !5
  store double 0x3FF3C0CA428C59FB, double* %magic, align 8, !taffo.initweight !7, !taffo.info !5
  %0 = load double, double* %magic, align 8, !taffo.initweight !7, !taffo.info !5
  %add = fadd double %0, 0x4002C3F2C52E6BF5, !taffo.initweight !8, !taffo.info !5
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %add), !taffo.initweight !9, !taffo.info !5
  ret i32 0
}
