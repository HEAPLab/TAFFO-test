...
entry:
  ...
  call void @llvm.var.annotation(i8* %z1, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0), i32 15)
  ...
  store float %conv, float* %a2, align 4
  %1 = load double, double* %b, align 8
  %conv3 = fptosi double %1 to i32
  %b4 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 1
  store i32 %conv3, i32* %b4, align 4
  %2 = load double, double* %c, align 8
  %conv5 = fptrunc double %2 to float
  %c6 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 2
  store float %conv5, float* %c6, align 4
  %a7 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 0
  %3 = load float, float* %a7, align 4
  %conv8 = fpext float %3 to double
  %b9 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 1
  %4 = load i32, i32* %b9, align 4
  %c10 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 2
  %5 = load float, float* %c10, align 4
  %conv11 = fpext float %5 to double
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), double %conv8, i32 %4, double %conv11)
  ret i32 0
}
