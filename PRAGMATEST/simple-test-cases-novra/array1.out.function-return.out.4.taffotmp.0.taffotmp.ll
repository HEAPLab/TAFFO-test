...
entry:
  ...
  %call = call float @fun.1(), !taffo.initweight !6, !taffo.info !7, !taffo.originalCall !10
  store float %call, float* %x, align 4, !taffo.initweight !11, !taffo.info !12
...
!6 = !{i32 0}
!7 = !{!8, !9, i1 false, i2 1}
!8 = !{!"fixp", i32 -32, i32 27}
!9 = !{double -1.000000e+01, double 1.000000e+01}
!10 = !{float ()* @fun}
!11 = !{i32 1}
!12 = !{i1 false, !9, i1 false, i2 1}
