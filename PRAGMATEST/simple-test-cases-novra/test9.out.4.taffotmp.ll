...
entry:
  ...
  %cake1 = bitcast float* %cake to i8*, !taffo.initweight !8, !taffo.info !9
  %0 = load i32, i32* %baked.addr, align 4
  %1 = load i32, i32* %stuff.addr, align 4
  %add = add nsw i32 %0, %1
  %conv = sitofp i32 %add to float
  store float %conv, float* %cake, align 4, !taffo.initweight !8, !taffo.info !10
  %2 = load float, float* %cake, align 4, !taffo.initweight !8, !taffo.info !5
  %3 = load float, float* %cherry.addr, align 4
  %add2 = fadd float %2, %3, !taffo.initweight !11, !taffo.info !5
  ret float %add2, !taffo.initweight !12, !taffo.info !10
}
