...
@global = dso_local global float 0x400AA9FBE0000000, align 4
...
entry:
  ...
  %mul = fmul float %2, %4
  %5 = load float, float* @global, align 4
  %add = fadd float %mul, %5
...
entry:
  ...
  %k = alloca float**, align 8
  %mall = alloca float*, align 8
  %i = alloca i32, align 4
  %i8 = alloca i32, align 4
  %i19 = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  %a1 = bitcast float** %a to i8*
  call void @llvm.var.annotation(i8* %a1, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 15)
  %b2 = bitcast float* %b to i8*
  call void @llvm.var.annotation(i8* %b2, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 18)
  store float 0x4024333340000000, float* %b, align 4
  store float 0x40019999A0000000, float* %c, align 4
  store float* %b, float** %a, align 8
  %k3 = bitcast float*** %k to i8*
  call void @llvm.var.annotation(i8* %k3, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 24)
  %mall4 = bitcast float** %mall to i8*
  call void @llvm.var.annotation(i8* %mall4, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 27)
  %call = call i8* @malloc(i64 25)
  %0 = bitcast i8* %call to float*
  store float* %0, float** %mall, align 8
  %1 = load float*, float** %mall, align 8
  %arrayidx = getelementptr inbounds float, float* %1, i64 0
  store float 0x3FB99999A0000000, float* %arrayidx, align 4
  %2 = load float*, float** %mall, align 8
  %add.ptr = getelementptr inbounds float, float* %2, i64 1
  store float 0x3FF19999A0000000, float* %add.ptr, align 4
  %3 = load float*, float** %mall, align 8
  %arrayidx5 = getelementptr inbounds float, float* %3, i64 2
  store float 0x40019999A0000000, float* %arrayidx5, align 4
...
for.body:                                         ; preds = %for.cond
  %5 = load float*, float** %mall, align 8
  %6 = load i32, i32* %i, align 4
  %idx.ext = sext i32 %6 to i64
  %add.ptr6 = getelementptr inbounds float, float* %5, i64 %idx.ext
  %7 = load float, float* %add.ptr6, align 4
  %conv = fpext float %7 to double
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv)
  br label %for.inc
...
for.body12:                                       ; preds = %for.cond9
  ...
  %12 = load float*, float** %mall, align 8
  %13 = load i32, i32* %i8, align 4
  %idxprom = sext i32 %13 to i64
  %arrayidx15 = getelementptr inbounds float, float* %12, i64 %idxprom
...
for.body23:                                       ; preds = %for.cond20
  %16 = load float*, float** %mall, align 8
  %17 = load i32, i32* %i19, align 4
  %idxprom24 = sext i32 %17 to i64
  %arrayidx25 = getelementptr inbounds float, float* %16, i64 %idxprom24
  %18 = load float, float* %arrayidx25, align 4
  %conv26 = fpext float %18 to double
  %call27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv26)
  br label %for.inc28
...
for.end30:                                        ; preds = %for.cond20
  ...
  %call32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv31)
  %call33 = call float** @fun(float** %a, float* %b)
  store float** %call33, float*** %k, align 8
  %22 = load float*, float** %a, align 8
  %23 = load float, float* %22, align 4
  %conv34 = fpext float %23 to double
  %call35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv34)
  %24 = load float**, float*** %k, align 8
  %25 = load float*, float** %24, align 8
  %26 = load float, float* %25, align 4
  %conv36 = fpext float %26 to double
  %call37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %conv36)
