; ModuleID = './test9.out.1.taffotmp.ll'
...
define dso_local float @oven(i32 %stuff, i32 %baked, float %cherry) #0 {
entry:
  ...
  call void @llvm.var.annotation(i8* %cake1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 6)
