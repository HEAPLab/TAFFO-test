...
entry:
  ...
  %phi1 = bitcast float* %phi to i8*, !taffo.initweight !9, !taffo.info !10
...
if.then:                                          ; preds = %entry
  ...
  store float %1, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  br label %if.end

if.else:                                          ; preds = %entry
  store float 1.500000e+00, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call = call float @random()
  %2 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  %mul = fmul float %2, %call, !taffo.initweight !12, !taffo.info !6
...
if.then3:                                         ; preds = %if.end
  ...
  %5 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  %add = fadd float %5, %4, !taffo.initweight !12, !taffo.info !6
  store float %add, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  %call4 = call float @random()
  %6 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  %mul5 = fmul float %6, %call4, !taffo.initweight !12, !taffo.info !6
  store float %mul5, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  br label %if.end8

if.else6:                                         ; preds = %if.end
  %call7 = call float @random()
  %7 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  %div = fdiv float %7, %call7, !taffo.initweight !12, !taffo.info !6
  store float %div, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  br label %if.end8
...
; Function Attrs: noinline nounwind uwtable
define dso_local float @test2(i32 %p1) #0 !taffo.initweight !13 !taffo.funinfo !14 {
entry:
  %p1.addr = alloca i32, align 4
  %phi = alloca float, align 4, !taffo.initweight !5, !taffo.info !6
  store i32 %p1, i32* %p1.addr, align 4
  %phi1 = bitcast float* %phi to i8*, !taffo.initweight !9, !taffo.info !10
  store float 0.000000e+00, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  %0 = load i32, i32* %p1.addr, align 4
  %tobool = icmp ne i32 %0, 0
  br i1 %tobool, label %if.then, label %if.else
...
if.then:                                          ; preds = %entry
  %call = call float @random()
  %1 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  %add = fadd float %1, %call, !taffo.initweight !12, !taffo.info !6
  store float %add, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  br label %if.end

if.else:                                          ; preds = %entry
  %2 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  %conv = fpext float %2 to double, !taffo.initweight !12, !taffo.info !6
  %add2 = fadd double %conv, 2.000000e+00, !taffo.initweight !15, !taffo.info !6
  %conv3 = fptrunc double %add2 to float, !taffo.initweight !16, !taffo.info !6
  store float %conv3, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call4 = call float @random()
  %3 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  %add5 = fadd float %3, %call4, !taffo.initweight !12, !taffo.info !6
  store float %add5, float* %phi, align 4, !taffo.initweight !9, !taffo.info !11
  %4 = load float, float* %phi, align 4, !taffo.initweight !9, !taffo.info !6
  ret float %4, !taffo.initweight !12, !taffo.info !11
}
