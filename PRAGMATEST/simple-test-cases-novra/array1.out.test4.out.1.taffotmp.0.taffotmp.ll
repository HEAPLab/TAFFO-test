...
entry:
  ...
  call void @llvm.var.annotation(i8* %f11, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 18)
  %call = call float @random()
  store float %call, float* %f1, align 4
  %f22 = bitcast float* %f2 to i8*
  call void @llvm.var.annotation(i8* %f22, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 20)
  %call3 = call float @random()
  store float %call3, float* %f2, align 4
  %phi4 = bitcast float* %phi to i8*
  call void @llvm.var.annotation(i8* %phi4, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 22)
