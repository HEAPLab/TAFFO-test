...
entry:
  ...
  %y1 = bitcast float* %y to i8*, !taffo.initweight !7, !taffo.info !5
  store float 2.000000e+00, float* %y, align 4, !taffo.initweight !7, !taffo.info !5
  store float 3.000000e+00, float* %z, align 4
  %0 = load float, float* %x, align 4
  %1 = load float, float* %y, align 4, !taffo.initweight !7, !taffo.info !5
  %2 = load float, float* %z, align 4
  %div = fdiv float %1, %2, !taffo.initweight !8, !taffo.info !5
  %mul = fmul float %0, %div, !taffo.initweight !9, !taffo.info !5
  %3 = load float, float* %x, align 4
  %mul2 = fmul float %mul, %3, !taffo.initweight !10, !taffo.info !5
  ret float %mul2, !taffo.initweight !11, !taffo.info !5
}

; Function Attrs: nounwind willreturn
declare !taffo.initweight !2 !taffo.funinfo !3 void @llvm.var.annotation(i8*, i8*, i8*, i32) #1
