...
entry:
  ...
  call void @llvm.var.annotation(i8* %abc.addr1, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 6)
  %0 = load float, float* %abc.addr, align 4
  %add = fadd float %0, 0x400921FB60000000
  ret float %add
}
...
entry:
  ...
  call void @llvm.var.annotation(i8* %test1, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 14)
  ...
  call void @llvm.var.annotation(i8* %abc.addr1.i, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 6) #4
  %1 = load float, float* %abc.addr.i, align 4
  %add.i = fadd float %1, 0x400921FB60000000
