; ModuleID = './test4.out.2.taffotmp.ll'
...
entry:
  ...
  %f11 = bitcast float* %f1 to i8*, !taffo.initweight !8, !taffo.info !6
  %call = call float @random()
  store float %call, float* %f1, align 4, !taffo.initweight !8, !taffo.info !6
  %f22 = bitcast float* %f2 to i8*, !taffo.initweight !8, !taffo.info !6
  %call3 = call float @random()
  store float %call3, float* %f2, align 4, !taffo.initweight !8, !taffo.info !6
  %phi4 = bitcast float* %phi to i8*, !taffo.initweight !8, !taffo.info !6
  %0 = load i32, i32* %p1.addr, align 4
  %tobool = icmp ne i32 %0, 0
  br i1 %tobool, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  store float 1.000000e+00, float* %phi, align 4, !taffo.initweight !8, !taffo.info !6
  br label %if.end

if.else:                                          ; preds = %entry
  store float 0x3FF3333340000000, float* %phi, align 4, !taffo.initweight !8, !taffo.info !6
  br label %if.end
...
cond.true:                                        ; preds = %if.end
  %2 = load float, float* %f1, align 4, !taffo.initweight !8, !taffo.info !6
  br label %cond.end

cond.false:                                       ; preds = %if.end
  %3 = load float, float* %f2, align 4, !taffo.initweight !8, !taffo.info !6
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi float [ %2, %cond.true ], [ %3, %cond.false ], !taffo.initweight !9, !taffo.info !6
  %4 = load float, float* %phi, align 4, !taffo.initweight !8, !taffo.info !6
  %mul = fmul float %4, %cond, !taffo.initweight !9, !taffo.info !6
...
if.then7:                                         ; preds = %cond.end
  ...
  %conv = fpext float %6 to double, !taffo.initweight !9, !taffo.info !6
  %add = fadd double %conv, 8.000000e-01, !taffo.initweight !10, !taffo.info !6
  %conv8 = fptrunc double %add to float, !taffo.initweight !11, !taffo.info !6
  store float %conv8, float* %phi, align 4, !taffo.initweight !8, !taffo.info !6
  br label %if.end13

if.else9:                                         ; preds = %cond.end
  %7 = load float, float* %phi, align 4, !taffo.initweight !8, !taffo.info !6
  %conv10 = fpext float %7 to double, !taffo.initweight !9, !taffo.info !6
  %add11 = fadd double %conv10, 3.000000e-01, !taffo.initweight !10, !taffo.info !6
  %conv12 = fptrunc double %add11 to float, !taffo.initweight !11, !taffo.info !6
  store float %conv12, float* %phi, align 4, !taffo.initweight !8, !taffo.info !6
  br label %if.end13
