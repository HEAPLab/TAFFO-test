; ModuleID = './test_cpp11attributes.out.2.taffotmp.ll'
...
entry:
  ...
  store i32 %stuff, i32* %stuff.addr, align 4, !taffo.initweight !7, !taffo.info !5
  %stuff.addr1 = bitcast i32* %stuff.addr to i8*, !taffo.initweight !7, !taffo.info !5
  store i32 %baked, i32* %baked.addr, align 4
  store float %cherry, float* %cherry.addr, align 4
  %cake2 = bitcast float* %cake to i8*, !taffo.initweight !7, !taffo.info !5
  %0 = load i32, i32* %baked.addr, align 4
  %1 = load i32, i32* %stuff.addr, align 4, !taffo.initweight !7, !taffo.info !5
  %add = add nsw i32 %0, %1, !taffo.initweight !8, !taffo.info !5
  %conv = sitofp i32 %add to float, !taffo.initweight !9, !taffo.info !5
  ...
  %add3 = fadd float %2, %3, !taffo.initweight !8, !taffo.info !5
  ret float %add3, !taffo.initweight !9, !taffo.info !5
}
