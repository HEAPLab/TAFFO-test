...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.1(float %x, float %y) #0 !taffo.initweight !23 !taffo.sourceFunction !17 !taffo.funinfo !24 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.2(float %x, float %y) #0 !taffo.initweight !25 !taffo.sourceFunction !17 !taffo.funinfo !26 {
entry:
  %x.addr = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.3(float %x, float %y) #0 !taffo.initweight !27 !taffo.sourceFunction !17 !taffo.funinfo !28 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.4(float %x, float %y) #0 !taffo.initweight !27 !taffo.sourceFunction !17 !taffo.funinfo !28 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.5(float %x, float %y) #0 !taffo.initweight !23 !taffo.sourceFunction !17 !taffo.funinfo !24 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4
  %local = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.6(float %x, float %y) #0 !taffo.initweight !25 !taffo.sourceFunction !17 !taffo.funinfo !26 {
entry:
  %x.addr = alloca float, align 4
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.7(float %x, float %y) #0 !taffo.initweight !25 !taffo.sourceFunction !17 !taffo.funinfo !26 {
entry:
  %x.addr = alloca float, align 4
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.8(float %x, float %y) #0 !taffo.initweight !23 !taffo.sourceFunction !17 !taffo.funinfo !24 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4
  %local = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @funInt.9(float %x, float %y) #0 !taffo.initweight !27 !taffo.sourceFunction !17 !taffo.funinfo !28 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.10(float %x, float %y) #0 !taffo.initweight !25 !taffo.sourceFunction !16 !taffo.funinfo !26 {
entry:
  %x.addr = alloca float, align 4
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.11(float %x, float %y) #0 !taffo.initweight !23 !taffo.sourceFunction !16 !taffo.funinfo !24 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.12(float %x, float %y) #0 !taffo.initweight !27 !taffo.sourceFunction !16 !taffo.funinfo !28 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.13(float %x, float %y) #0 !taffo.initweight !27 !taffo.sourceFunction !16 !taffo.funinfo !28 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.14(float %x, float %y) #0 !taffo.initweight !23 !taffo.sourceFunction !16 !taffo.funinfo !24 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.15(float %x, float %y) #0 !taffo.initweight !25 !taffo.sourceFunction !16 !taffo.funinfo !26 {
entry:
  %x.addr = alloca float, align 4
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.16(float %x, float %y) #0 !taffo.initweight !27 !taffo.sourceFunction !16 !taffo.funinfo !28 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.17(float %x, float %y) #0 !taffo.initweight !27 !taffo.sourceFunction !16 !taffo.funinfo !28 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.18(float %x, float %y) #0 !taffo.initweight !25 !taffo.sourceFunction !16 !taffo.funinfo !26 {
entry:
  %x.addr = alloca float, align 4
  %y.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %local = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal float @fun.19(float %x, float %y) #0 !taffo.initweight !23 !taffo.sourceFunction !16 !taffo.funinfo !24 {
entry:
  %x.addr = alloca float, align 4, !taffo.initweight !10, !taffo.info !14
  %y.addr = alloca float, align 4
  %local = alloca float, align 4
