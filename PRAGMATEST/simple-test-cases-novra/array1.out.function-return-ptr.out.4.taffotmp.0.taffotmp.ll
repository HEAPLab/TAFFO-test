...
entry:
  ...
  %x1 = bitcast float** %x to i8*, !taffo.initweight !8, !taffo.info !10
  %call = call float* @fun.1(), !taffo.initweight !0, !taffo.info !1, !taffo.originalCall !11
  store float* %call, float** %x, align 8, !taffo.initweight !8, !taffo.info !9
  ...
  %1 = load float*, float** %x, align 8, !taffo.initweight !8, !taffo.info !1
  store float %0, float* %1, align 4, !taffo.initweight !12, !taffo.info !9
  %2 = load float*, float** %x, align 8, !taffo.initweight !8, !taffo.info !1
  %3 = load float, float* %2, align 4, !taffo.initweight !12, !taffo.info !1
  %conv = fpext float %3 to double, !taffo.initweight !13, !taffo.info !1
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double %conv), !taffo.initweight !14, !taffo.info !10
  ret i32 0
}

declare !taffo.initweight !15 !taffo.funinfo !16 dso_local i32 @__isoc99_scanf(i8*, ...) #1

declare !taffo.initweight !15 !taffo.funinfo !16 dso_local i32 @printf(i8*, ...) #1

; Function Attrs: noinline nounwind uwtable
define internal float* @fun.1() #0 !taffo.initweight !6 !taffo.funinfo !6 !taffo.sourceFunction !11 {
entry:
  ret float* @glob, !taffo.initweight !8, !taffo.info !9
}
