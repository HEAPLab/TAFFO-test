...
entry:
  ...
  call void @llvm.var.annotation(i8* %buf1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 134)
...
for.end23:                                        ; preds = %for.cond10
  ...
  call void @llvm.var.annotation(i8* %sync24, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 139)
  %sync25 = bitcast float* %sync to i8*
  call void @llvm.var.annotation(i8* %sync25, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 139)
...
for.end94:                                        ; preds = %for.cond81
  ...
  call void @llvm.var.annotation(i8* %sync9596, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 144)
  %sync9597 = bitcast float* %sync95 to i8*
  call void @llvm.var.annotation(i8* %sync9597, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 144)
