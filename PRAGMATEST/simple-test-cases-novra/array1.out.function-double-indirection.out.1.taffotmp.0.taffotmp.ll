...
entry:
  ...
  %x21 = bitcast float* %x2 to i8*
  call void @llvm.var.annotation(i8* %x21, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1, i32 0, i32 0), i32 28)
...
entry:
  ...
  call void @llvm.var.annotation(i8* %x1, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1, i32 0, i32 0), i32 38)
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), double %conv)
  call void @function_2_1(float* %x)
  %2 = load float, float* %x, align 4
  %conv2 = fpext float %2 to double
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), double %conv2)
  ret i32 0
}
