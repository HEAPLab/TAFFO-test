; ModuleID = './malloc.out.1.taffotmp.ll'
...
entry:
  ...
  call void @llvm.var.annotation(i8* %test1, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 8)
