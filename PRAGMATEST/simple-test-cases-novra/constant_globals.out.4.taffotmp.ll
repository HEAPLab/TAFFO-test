; ModuleID = './constant_globals.out.3.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [5 x float], [5 x float]* @k, i64 0, i64 %idxprom, !taffo.initweight !8, !taffo.info !1
  %2 = load float, float* %arrayidx, align 4, !taffo.initweight !9, !taffo.info !1
  %conv = fpext float %2 to double, !taffo.initweight !10, !taffo.info !1
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double %conv), !taffo.initweight !11, !taffo.info !12
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond7
  ...
  %arrayidx12 = getelementptr inbounds [3 x [3 x float]], [3 x [3 x float]]* @kx, i64 0, i64 %idxprom11, !taffo.initweight !8, !taffo.info !1
  %7 = load i32, i32* %j, align 4
  %idxprom13 = sext i32 %7 to i64
  %arrayidx14 = getelementptr inbounds [3 x float], [3 x float]* %arrayidx12, i64 0, i64 %idxprom13, !taffo.initweight !9, !taffo.info !1
  %8 = load float, float* %arrayidx14, align 4, !taffo.initweight !10, !taffo.info !1
  %conv15 = fpext float %8 to double, !taffo.initweight !11, !taffo.info !1
  %9 = load i32, i32* %i2, align 4
  %idxprom16 = sext i32 %9 to i64
  %arrayidx17 = getelementptr inbounds [3 x [3 x float]], [3 x [3 x float]]* @ky, i64 0, i64 %idxprom16, !taffo.initweight !8, !taffo.info !1
  %10 = load i32, i32* %j, align 4
  %idxprom18 = sext i32 %10 to i64
  %arrayidx19 = getelementptr inbounds [3 x float], [3 x float]* %arrayidx17, i64 0, i64 %idxprom18, !taffo.initweight !9, !taffo.info !1
  %11 = load float, float* %arrayidx19, align 4, !taffo.initweight !10, !taffo.info !1
  %conv20 = fpext float %11 to double, !taffo.initweight !11, !taffo.info !1
  %call21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), double %conv15, double %conv20), !taffo.initweight !13, !taffo.info !12
  br label %for.inc22
