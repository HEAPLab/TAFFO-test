; ModuleID = './test6.out.1.taffotmp.ll'
...
entry:
  ...
  call void @llvm.var.annotation(i8* %c1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 6)
  %b2 = bitcast float** %b to i8*
  call void @llvm.var.annotation(i8* %b2, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i32 8)
