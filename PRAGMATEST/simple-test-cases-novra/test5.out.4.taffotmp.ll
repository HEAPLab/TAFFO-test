...
entry:
  ...
  store float %a, float* %a.addr, align 4, !taffo.initweight !8, !taffo.info !9
  %a.addr1 = bitcast float* %a.addr to i8*, !taffo.initweight !8, !taffo.info !10
  store double %b, double* %b.addr, align 8, !taffo.initweight !8, !taffo.info !9
  %b.addr2 = bitcast double* %b.addr to i8*, !taffo.initweight !8, !taffo.info !10
  store double 1.230000e+02, double* %c, align 8
  %0 = load float, float* %a.addr, align 4, !taffo.initweight !8, !taffo.info !5
  %conv = fpext float %0 to double, !taffo.initweight !11, !taffo.info !5
  %1 = load double, double* %c, align 8
  %add = fadd double %1, %conv, !taffo.initweight !12, !taffo.info !5
  store double %add, double* %c, align 8, !taffo.initweight !13, !taffo.info !9
  %2 = load double, double* %c, align 8
  %conv3 = fptrunc double %2 to float
  %conv4 = fpext float %conv3 to double
  %3 = load double, double* %b.addr, align 8, !taffo.initweight !8, !taffo.info !5
  %add5 = fadd double %conv4, %3, !taffo.initweight !11, !taffo.info !5
  %conv6 = fptrunc double %add5 to float, !taffo.initweight !12, !taffo.info !5
  ret float %conv6, !taffo.initweight !13, !taffo.info !9
}
