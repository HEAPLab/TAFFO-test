...
entry:
  ...
  %a1 = bitcast double* %a to i8*, !taffo.initweight !7, !taffo.info !8
  ...
  store double %mul, double* %a, align 8, !taffo.initweight !7, !taffo.info !9
  %3 = load double, double* %a, align 8, !taffo.initweight !7, !taffo.info !4
  ret double %3, !taffo.initweight !10, !taffo.info !9
}

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main(i32 %argc, i8** %argv) #0 !taffo.initweight !11 !taffo.funinfo !12 {
entry:
...
!3 = !{i32 0}
!4 = !{!5, !6, i1 false, i2 1}
!5 = !{!"fixp", i32 -32, i32 24}
!6 = !{double -1.000000e+02, double 1.000000e+02}
!7 = !{i32 1}
!8 = !{!5, i1 false, i1 false, i2 1}
!9 = !{i1 false, !6, i1 false, i2 1}
!10 = !{i32 2}
!11 = !{i32 -1, i32 -1}
