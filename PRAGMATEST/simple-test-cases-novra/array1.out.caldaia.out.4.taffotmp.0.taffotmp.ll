...
entry:
  ...
  %p11 = bitcast float* %p1 to i8*, !taffo.initweight !8, !taffo.info !9
  %p22 = bitcast float* %p2 to i8*, !taffo.initweight !8, !taffo.info !9
  %sPeak3 = bitcast float* %sPeak to i8*, !taffo.initweight !8, !taffo.info !9
  %sAll4 = bitcast float* %sAll to i8*, !taffo.initweight !8, !taffo.info !9
  store float -1.000000e+00, float* %p1, align 4, !taffo.initweight !8, !taffo.info !10
  store float -1.000000e+00, float* %p2, align 4, !taffo.initweight !8, !taffo.info !10
  store float -1.000000e+00, float* %p3, align 4
  store float 0.000000e+00, float* %sAll, align 4, !taffo.initweight !8, !taffo.info !10
  store float 0.000000e+00, float* %sPeak, align 4, !taffo.initweight !8, !taffo.info !10
...
land.lhs.true:                                    ; preds = %while.body
  ...
  %cmp6 = fcmp ogt float %2, 0.000000e+00, !taffo.initweight !11, !taffo.info !9
  br i1 %cmp6, label %land.lhs.true7, label %if.end13, !taffo.initweight !12, !taffo.info !10

land.lhs.true7:                                   ; preds = %land.lhs.true
  %3 = load float, float* %p1, align 4, !taffo.initweight !8, !taffo.info !5
  %cmp8 = fcmp ogt float %3, 0.000000e+00, !taffo.initweight !11, !taffo.info !9
  br i1 %cmp8, label %if.then, label %if.end13, !taffo.initweight !12, !taffo.info !10

if.then:                                          ; preds = %land.lhs.true7
  %4 = load float, float* %p3, align 4
  %5 = load float, float* %p2, align 4, !taffo.initweight !8, !taffo.info !5
  %cmp9 = fcmp olt float %4, %5, !taffo.initweight !11, !taffo.info !9
  br i1 %cmp9, label %land.lhs.true10, label %if.end, !taffo.initweight !12, !taffo.info !10
...
land.lhs.true10:                                  ; preds = %if.then
  ...
  %cmp11 = fcmp olt float %6, %7, !taffo.initweight !11, !taffo.info !9
  br i1 %cmp11, label %if.then12, label %if.end, !taffo.initweight !12, !taffo.info !10
...
if.then12:                                        ; preds = %land.lhs.true10
  ...
  %add = fadd float %9, %8, !taffo.initweight !11, !taffo.info !5
  store float %add, float* %sPeak, align 4, !taffo.initweight !8, !taffo.info !10
...
if.end13:                                         ; preds = %if.end, %land.lhs.true7, %land.lhs.true, %while.body
  ...
  %add14 = fadd float %12, %11, !taffo.initweight !11, !taffo.info !5
  store float %add14, float* %sAll, align 4, !taffo.initweight !8, !taffo.info !10
  ...
  store float %14, float* %p1, align 4, !taffo.initweight !8, !taffo.info !10
  %15 = load float, float* %p3, align 4
  store float %15, float* %p2, align 4, !taffo.initweight !8, !taffo.info !10
...
if.then19:                                        ; preds = %while.end
  ...
  %div = fdiv float %17, %conv, !taffo.initweight !11, !taffo.info !5
  %conv20 = fpext float %div to double, !taffo.initweight !12, !taffo.info !5
  %call21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), double %conv20), !taffo.initweight !13, !taffo.info !9
  br label %if.end23
...
if.then27:                                        ; preds = %if.end23
  ...
  %div29 = fdiv float %20, %conv28, !taffo.initweight !11, !taffo.info !5
  %conv30 = fpext float %div29 to double, !taffo.initweight !12, !taffo.info !5
  %call31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), double %conv30), !taffo.initweight !13, !taffo.info !9
  br label %if.end34
