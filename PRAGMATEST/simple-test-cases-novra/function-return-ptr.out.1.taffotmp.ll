...
entry:
  ...
  call void @llvm.var.annotation(i8* %x1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i32 20)
  %call = call float* @fun()
